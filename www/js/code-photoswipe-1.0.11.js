...
//HAMID STAR///////////////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			this.el = Util.DOM.createElement('div', { 'class': 'smgroup-box' }, '');
			Util.DOM.setStyle(this.el, {
				position: 'absolute',
				top: '24.7%',
				zIndex: this.settings.zIndex-2,
				left: (Util.DOM.bodyWidth() - Util.DOM.windowHeight()*0.64*1657/1012)/2  + 'px',
			});
			Util.DOM.width(this.el,  Util.DOM.windowHeight()*0.64*1657/1012				);
			Util.DOM.height(this.el, Util.DOM.windowHeight()*0.64						);
			Util.DOM.appendToBody(this.el);
			...
			parentEl = this.el;
			//716*268///2560*1600//1657/1012
			this.el = Util.DOM.createElement('div', { 'class': 'smgroup-logo' }, '<img src="images/gallery/logo.png" style="width:100%;height:100%;">');
			Util.DOM.setStyle(this.el, {
				top: '-' + Util.DOM.windowHeight()*0.165 + 'px',
				right:'-' + (Util.DOM.windowHeight()*0.165*112/268)  + 'px',//left: (Util.DOM.bodyWidth() - Util.DOM.windowHeight()*0.64*1657/1012)/2  + 'px',
			});
			Util.DOM.width(this.el,  Util.DOM.windowHeight()*0.165*716/268				);
			Util.DOM.height(this.el, Util.DOM.windowHeight()*0.165						);
			Util.DOM.appendChild(this.el, parentEl);
			
			
			
			this.el = Util.DOM.createElement('div', { 'class': 'smgroup-border' }, '');
			Util.DOM.setStyle(this.el, {
				//top: '-' + Util.DOM.windowHeight()*0.165 + 'px',
				//right:'-' + (Util.DOM.windowHeight()*0.165*112/268)  + 'px',//left: (Util.DOM.bodyWidth() - Util.DOM.windowHeight()*0.64*1657/1012)/2  + 'px',
			});
			Util.DOM.width(this.el,  Util.DOM.windowHeight()*0.64*1657/1012	-140			);
			Util.DOM.height(this.el, Util.DOM.windowHeight()*0.64 + 8						);
			Util.DOM.appendChild(this.el, parentEl);
			
			
			
			this.el = Util.DOM.createElement('div', { 'id': 'smgroup-caption' }, '');
			Util.DOM.setStyle(this.el, {
			...
			this.el = Util.DOM.createElement('div', { 'id': 'smgroup-tree1' }, '');
			Util.DOM.setStyle(this.el, {	});
			Util.DOM.appendChild(this.el, parentEl);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////			
			// Create element and append to body
			this.el = Util.DOM.createElement('div', { 'class': Code.PhotoSwipe.ViewportClass.CssClasses.viewport, 'data-role': 'dialog' }, '<div id="smgroup-tree2"></div>');
			//PhotoSwipe-viewport CSS :
...
//HAMID STAR///////////////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			//this.el = Util.DOM.createElement('div', { 'class': 'smgroup-logo' }, '');
			//Util.DOM.appendChild(this.el, parentEl);
//HAMID END///////////////////////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
// START Hamid//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////	
			...
			temp = document.getElementById("smgroup-caption");	
			//this.contentEl = document.getElementById("smgroup-caption");
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// END Hamid//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
// START Hamid//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			if (Util.isObject(captionValue)){
				...
				Util.DOM.appendChild(captionValue, temp);
			}
			else{
				if (captionValue === ''){
					captionValue = '\u00A0';
				...
				Util.DOM.appendText(captionValue, temp);	
			}
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// END Hamid//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
